...
class MyModel(nn.Module):
    def __init__(self, seq_len, num_feature, is_quantile):
        ...
        cnn_kernel_size2 = 16
        cnn_kernel_size3 = 3
        size_after_cnn = cnn_hidden_size - cnn_kernel_size1 - cnn_kernel_size2 - cnn_kernel_size3 + 3
        ff_hidden_size = 64
        ...
        self.weight = nn.Linear(w_hidden_size, cnn_hidden_size)
        ...
        self.linear1 = nn.Linear(w_hidden_size+size_after_cnn, ff_hidden_size)
    ...
    def forward(self, inputs):
        ...
        # cnn_ht1 - (batch_size, seq_len, w_hidden_size - cnn_kernel_size1 + 1)
        cnn_ht1 = self.cnn1(self.batch_norm2(hidden_state))
        cnn_ht2 = self.cnn2(self.batch_norm3(cnn_ht1))
        # cnn_ht3 - (batch_size, seq_len, size_after_cnn)
        cnn_ht3 = self.cnn3(self.batch_norm4(cnn_ht2))
